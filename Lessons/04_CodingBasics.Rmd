...
vector1[3] # 
#Calling out the third number of vector one
# Matrices ----
matrix1 <- matrix(1:20, nrow = 5,ncol = 4) # 
matrix1
matrix2 <- matrix(1:20, nrow = 5, ncol = 4, byrow = TRUE) #
#matrix2 defaults to populate matrix by column unless you specifiy by row
...
# using a ";" lets you run two lines of code at once
list1[[2]]

# Data Frames ----
d <- c(1, 2, 3, 4) # What type of vector? d= numeric
e <- c("red", "white", "red", NA) # What type of vector? e=character
f <- c(TRUE, TRUE, TRUE, FALSE) # What type of vector? f= logical
dataframe1 <- data.frame(d,e,f) #
names(dataframe1) <- c("ID","Color","Passed"); View(dataframe1) # 

dataframe1[1:2] # This would give us columns 1 and 2. If we used a matrix, it would give us elements 1 and 2
