...
# Coerce into a data frame, ensure consistent lengths and removing the extra data that we grabbed by accident
...
riverdata$Name <- str_replace(riverdata$Name, "\\[.*\\]", "") #looks for a square bracket and removes everything inside it
