...
# Add a line of best fit for the linear regression of these variables.
  ggplot(EPAair, aes(x = PM25, y = Ozone, color = Site.Name)) +  # the color is defined inside the aesthetics,each site gets its own trend line because aesthetics were defined at the top
  geom_point() +
