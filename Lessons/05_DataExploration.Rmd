...
```{r}
# Absolute file path (not recommended) It's not recommended because the path will only work on this computer server.
...
str(USGS.flow.data) # structure: tels you the structure of the data
dim(USGS.flow.data) # tells you the dimension
length(USGS.flow.data) # length tells you the number of columns

head(USGS.flow.data) #first couple rows of each column
head(USGS.flow.data, 10)
tail(USGS.flow.data, 5) # last few rows of each column
USGS.flow.data[30000:30005, c(3, 8, 14)] # selection a series of columns and rows in the dataset
...
> ANSWER: They become NA in the data
