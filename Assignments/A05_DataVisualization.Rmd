...
facet_grid(concentration ~ nutrient)
```
...
neonic <- ggplot(subset(neonicotinoids.A05, Conc..Units..Std. == "AL mg/L"), aes(x = Chemical.Name, y = Conc..Mean..Std., fill = as.factor(Chemical.Name)))+
