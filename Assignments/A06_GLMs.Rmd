...
The ANCOVA generated an r^2 value of 0.77, which means that accounting for the interaction between depth and lakename creates an r^2 value that is 0.04 higher than just accounting for depth alone.
...
```{r}
#16
temperature.vs.depth.plot <- ggplot(chemistry.physics.processed.A06, aes(x = depth, y = tn_ug, color = lakename)) + 
  geom_point() + 
